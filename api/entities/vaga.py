class Vaga():
    def __init__(self,self.__titulo,self.__descricao,self.__salario,self.__local,self.__
            quantidade,self.__contato,self.__tipo_contratacao,self.__ tecnologias):
