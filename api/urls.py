...
urlpatterns = [
    ...
    path('tecnologias/<int:id>', tecnologia_view.TecnologiaDetail.as_view(), name='tecnologia-detalhes'),
    path('vagas/', vaga_view.VagaList.as_view(),name='vaga-list'),
    path('vagas/<int:id>', vaga_view.VagaDetail.as_view(), name='vaga-detalhes'),
